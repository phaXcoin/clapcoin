...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Clapcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"clapcointools.com", "35.190.143.226"},
    {"clapcointool.com", "35.196.171.1"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Clapcoin is probably already running."), addrBind.ToString().c_str());
        else
